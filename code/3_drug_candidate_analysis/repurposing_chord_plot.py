...
hv.extension('bokeh')
link = pd.read_csv("../../result/drug_result/repurposing_link.csv")
node = pd.read_csv("../../result/drug_result/repurposing_node.csv")
del link["Unnamed: 0"]
del node["Unnamed: 0"]
...
hv.save(chord, '../../result/drug_result/repurposing_chord.svg', fmt='svg')
hv.save(chord, '../../result/drug_result/repurposing_chord.pdf', fmt='pdf')
